...
const COUNTRIES = {
  colombia: {
    ...
    flag: '🇨🇴',
    titleEs: 'Crear LLC en USA desde Colombia',
    titleEn: 'Open a US LLC from Colombia',
  ...
  mexico: {
    ...
    flag: '🇲🇽',
    titleEs: 'Crear LLC en USA desde México',
    titleEn: 'Open a US LLC from Mexico',
  ...
  venezuela: {
    ...
    flag: '🇻🇪',
    titleEs: 'Crear LLC en USA desde Venezuela',
    titleEn: 'Open a US LLC from Venezuela',
  ...
  argentina: {
    ...
    flag: '🇦🇷',
    titleEs: 'Crear LLC en USA desde Argentina',
    titleEn: 'Open a US LLC from Argentina',
  ...
  peru: {
    ...
    flag: '🇵🇪',
    titleEs: 'Crear LLC en USA desde Perú',
    titleEn: 'Open a US LLC from Peru',
  ...
  chile: {
    ...
    flag: '🇨🇱',
    titleEs: 'Crear LLC en USA desde Chile',
    titleEn: 'Open a US LLC from Chile',
  ...
  ecuador: {
    ...
    flag: '🇪🇨',
    titleEs: 'Crear LLC en USA desde Ecuador',
    titleEn: 'Open a US LLC from Ecuador',
  ...
  espana: {
    ...
    flag: '🇪🇸',
    titleEs: 'Crear LLC en USA desde España',
    titleEn: 'Open a US LLC from Spain',
